...
################################################# Header
   function drawHeader($s=0){
	...
	<a   class='btn btn-lg btn-block addads adds ' href='createads.php'>+ Place an Ad</a></div>";
			...
			logout();
			ECHO "<a  href='dashboard.php' ><button type='button' class='btn button btnuserlogn' name='dashboard'>
			Dashboard
			</button></a>";
			ECHO "<a  href='controlAccountsUsers.php' ><button type='button' class='btn button btnuserlogn' name='submitlogin'>
			Admin control Panel
			</button></a>
			</header>";
		}else{
						...
						<div class='col-12 float-left'>
							<form action='login.php' method='POST'>
								<div class='form-group'>
									...
									<input type='text' class='form-control'  placeholder='Your Email' name='usernamelogin' required>
